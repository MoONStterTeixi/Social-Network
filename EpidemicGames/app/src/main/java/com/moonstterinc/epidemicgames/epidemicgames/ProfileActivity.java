...
public class ProfileActivity extends AppCompatActivity {
    ...
    private TextView tv_username, tv_checkID, pass, set_result;
    private ImageView iv_image,image_profile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Toast.makeText(this, "Username:"+DataClass.GlobalUser.getUsername()+" Genero: "+DataClass.GlobalUser.getGenre(), Toast.LENGTH_LONG).show();
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(resultCode == RESULT_OK){
            ...
            set_result.setText("La imagen de perfil cambiará al siguiente inicio.");
            saveData();
        }
    }
            ...
            if (!unlock){
                ...
                btnFollow.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (!validateEmail(ce_email.getText().toString())) {
                            ce_email.setError("Correo inválido.");
                            ce_email.requestFocus();
                        } else {
                            ...
                            try {
                                DataClass.usr = new User(DataClass.GlobalUser.getUsername(), ce_email.getText().toString().replace(" ", ""), cryptohashFinal, DataClass.GlobalUser.getGenre(), DataClass.GlobalUser.getSub());
        ...
        if (!unlock){
            ...
            btnFollow.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (!isValid(new_pass.getText().toString())) {
                        new_pass.setError("Contraseña inválida:\n" +
                                "-Mínimo 1 Número,\n" +
                        ...
                        try{
                            ...
                            DataClass.usr = new User(DataClass.GlobalUser.getUsername(),DataClass.GlobalUser.getEmail(), cryptohashFinal, DataClass.GlobalUser.getGenre(),DataClass.GlobalUser.getSub());
                            new CallAPI_Rest().execute("http://www.moonstterinc.com/SN/query.php?action=update&json="+DataClass.usr.toJson()).get();
    ...
    public void ShowGenre(View v) {
        if (!unlock){
            ...
            final Spinner spinner = (Spinner) myDialog.findViewById(R.id.profile_selcgen);
